...
p 9.0E7*(3./4./pi)**(-0.36/3.)*3.**(0.36/3.)*(x)**(-0.36/3.0) + 0.5*(3./4./pi)**(1.36/3.)*3.**(1.0-1.36/3.)*(x)**(1.36/3.) lw 2 t "Basalt, r = 3 [g/cc], v_{imp} = 5 [km/s]",\
3.5E7*(3./4./pi)**(-0.38/3.)*3.**(0.38/3.)*(x)**(-0.38/3.0) + 0.3*(3./4./pi)**(1.36/3.)*3.**(1.0-1.36/3.)*(x)**(1.36/3.) lw 2 t "Basalt, r = 3 [g/cc], v_{imp} = 3 [km/s]"
